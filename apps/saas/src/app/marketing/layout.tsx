...
const NAV_ITEMS = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Leads", href: "/marketing/leads", icon: Target },
      { label: "Patient Sources", href: "/marketing/patient-sources", icon: Share2 },
      { label: "Referrals", href: "/marketing/referrals", icon: Users },
    ],
  },
  {
    label: "CRM",
    items: [
      ...
      { label: "Communications", href: "/marketing/communications", icon: MessageSquare },
      { label: "Tasks", href: "/marketing/tasks", icon: ListTodo },
  ...
  },
  {
    label: "Finance",
    items: [
      { label: "Commission", href: "/marketing/commission", icon: DollarSign },
      { label: "Reports", href: "/marketing/reports", icon: BarChart3 },
    ],
  },
  {
    label: "Care",
    items: [
      { label: "Coordinators", href: "/marketing/coordinators", icon: HeartPulse },
      { label: "Activity Logs", href: "/marketing/activity-logs", icon: Activity },
    ],
  },
  {
    label: "System",
