...
const STATUS_COLORS: Record<string, string> = {
  new: "bg-purple-100 text-purple-700 dark:bg-purple-950/50 dark:text-purple-300",
  contacted: "bg-blue-100 text-blue-700 dark:bg-blue-950/50 dark:text-blue-300",
  qualified: "bg-emerald-100 text-emerald-700 dark:bg-emerald-950/50 dark:text-emerald-300",
  ...
  return (
    <div className="space-y-4 animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white leading-tight">Leads</h1>
                ...
                {filtered.map((l) => (
                  ...
                  >
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-3">
                        <div className="w-9 h-9 rounded-full bg-gradient-to-br from-purple-500 to-violet-600 flex items-center justify-center text-white text-xs font-bold">
                          {l.name ? l.name.slice(0, 2).toUpperCase() : "??"}
                        </div>
                    ...
                    <td className="px-4 py-3 hidden md:table-cell">
                      <span className="text-sm text-gray-600 dark:text-gray-400 capitalize">{l.source || "—"}</span>
                    </td>
                    <td className="px-4 py-3">
                      <span
                    ...
                    <td className="px-4 py-3 hidden lg:table-cell">
                      <span className="text-sm text-gray-600 dark:text-gray-400">{l.assignedTo || "—"}</span>
                    </td>
